          ...
          >
            {active.value === tab.value && (
              <motion.div
                ...
                className={cn(
                  "absolute inset-0 bg-green-500 dark:bg-[rgba(21,174,0,0.5)] rounded-full cursor-pointer ",
                  activeTabClassName
                )}
              />
            )}

            <span className="relative block text-black dark:text-white text-xl cursor-pointer">
              {tab.title}
            </span>
          </button>
        ))}
